<?php
include 'ChangeHandler.php'; // To handle changes in an array.
// Shared
 ...
 */
function renderPageT3(array $userInput = []): void
{
    ...
    echo <<<HTML
            <form method="post" action="">
                <button type="submit" name="deleteSession">Reset (Kurt Nilsen)</button>
            </form>
        HTML;
}
